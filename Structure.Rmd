...
csf <- wave1_wide[seq(from = 2, to = dim(wave1_wide)[2], by = 4)]
gm <- wave1_wide[seq(from = 3, to = dim(wave1_wide)[2], by = 4)]
mt <- wave1_wide[seq(from = 4, to = dim(wave1_wide)[2], by = 4)]
wm <- wave1_wide[seq(from = 5, to = dim(wave1_wide)[2], by = 4)]
