...
# plot boxplots using base package
...
combined <- combine_df %>% 
  ...
  unite("var_combined", hemisphere, region, var) %>% 
  spread(var_combined, value)  

# Show boxplots

csf = boxplot(ylab = "normalized Volume a.u.", combined[seq(from=2, to=dim(combined)[2], by=4)])
gM = boxplot(ylab = "normalized Volume a.u.", combined[seq(from=3, to=dim(combined)[2], by=4)])
mT = boxplot(ylab = "normalized Volume a.u.", combined[seq(from=4, to=dim(combined)[2], by=4)])
wM = boxplot(ylab = "normalized Volume a.u.", combined[seq(from=5, to=dim(combined)[2], by=4)])
